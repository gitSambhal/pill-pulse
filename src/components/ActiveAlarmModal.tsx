    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
        <motion.div
          ...
          className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col relative overflow-hidden my-auto"
          role="dialog"
          aria-modal="true"
        >
          ...
          {dose.routineName && (
            <div className="mb-5 p-3.5 rounded-2xl bg-teal-50 dark:bg-teal-950/40 border border-teal-100 dark:border-teal-900/60 flex items-center justify-between">
              <div>
          ...
          <div className="text-center my-4">
            <motion.div
              ...
              className={`inline-flex items-center justify-center w-20 h-20 rounded-3xl mb-3.5 shadow-lg ${colorStyle.bg} ${colorStyle.text} border ${colorStyle.border}`}
            >
            ...
            {dose.instructions && (
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-2.5 px-4 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-800/80 inline-block max-w-xs leading-relaxed">
                {dose.instructions}
              </p>
            )}
          </div>
          ...
          {dose.nextMedicineName && (
            <div className="mt-1 mb-5 text-center text-xs text-slate-500 dark:text-slate-400 flex items-center justify-center gap-1.5">
          ...
          <div className="mt-4 space-y-3">
            <button
              onClick={() => onTake(dose)}
              className="w-full py-3.5 px-5 bg-teal-600 hover:bg-teal-700 active:scale-[0.98] text-white font-semibold text-sm sm:text-base rounded-2xl shadow-lg shadow-teal-500/20 transition-all flex items-center justify-center gap-2 min-h-[48px]"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="py-2.5 px-3 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold text-xs rounded-xl transition-colors flex items-center justify-center gap-1.5 min-h-[42px]"
              >
              ...
              <button
                onClick={() => onSkip(dose)}
                className="py-2.5 px-3 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 font-semibold text-xs rounded-xl transition-colors min-h-[42px]"
              >
                Skip This Dose
              </button>
            </div>
