...
export const DateNavigator: React.FC<DateNavigatorProps> = ({
  ...
  return (
    <div className="space-y-2 mb-3">
      {/* Top Controls Bar */}
      <div className="flex items-center justify-between bg-white dark:bg-slate-900 p-2.5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs">
        {/* Previous Day */}
        <button
        ...
        <div className="flex items-center gap-1">
          {!isCurrentDayToday && (
            <button
              ...
              className="px-2 py-1 text-[11px] font-semibold text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-950/60 hover:bg-teal-100 dark:hover:bg-teal-900/60 rounded-lg transition-colors flex items-center gap-1"
              title="Jump to today"
            >
          ...
          <label
            className="relative p-1.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer flex items-center justify-center"
      ...
      <div className="grid grid-cols-7 gap-1 bg-white dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs">
        {weekDays.map((item) => {
      ...
      {!isCurrentDayToday && (
        <div
          className={`px-3.5 py-2 rounded-xl text-xs flex items-center justify-between gap-2 border ${
            isCurrentDayPast
